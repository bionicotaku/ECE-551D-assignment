...
public:
  ...
  void testAddFront() {
    ...
    assert(il[0] == 0 && il.head->data == 0 && il.tail->data == 0 &&
           il.head->prev == NULL && il.head->next == NULL &&
           il.tail->prev == NULL && il.tail->next == NULL && il.getSize() == 1);

    il.addFront(1);
    assert(il[0] == 1 && il.head->data == 1 && il.head->next != NULL &&
           il.head->next->data == 0 && il.head->prev == NULL &&
           il.tail->data == 0 && il.tail->next == NULL && il.tail->prev != NULL &&
           il.tail->prev->data == 1 && il.getSize() == 2);
    ...
    assert(nil1[0] == 1 && nil1[100] == 1 && nil1.head->data == 1 &&
           nil1.tail->data == 1 && nil1.getSize() == 101 && il[0] == 99 &&
           il[99] == 0 && il.getSize() == 100 && il.head->data == 99 &&
           il.tail->data == 0);
    ...
    assert(nil2[0] == 1 && nil2[100] == 1 && nil2.head->data == 1 &&
           nil2.tail->data == 1 && nil2.getSize() == 101 && il[0] == 99 &&
           il[99] == 0 && il.getSize() == 100 && il.head->data == 99 &&
           il.tail->data == 0);
  }
  ...
  void testAddBack() {
    IntList il;
    il.addBack(0);
    assert(il.head != NULL && il[0] == 0 && il.head->data == 0 &&
           il.tail->data == 0 && il.head->prev == NULL && il.head->next == NULL &&
           il.tail->prev == NULL && il.tail->next == NULL && il.getSize() == 1);

    il.addBack(1);
    assert(il[0] == 0 && il[1] == 1 && il.head->data == 0 &&
    ...
    nil1.head->data = 1;
    assert(nil1[0] == 1 && nil1[100] == 1 && nil1.head->data == 1 &&
           nil1.tail->data == 1 && nil1.getSize() == 101 && il[0] == 0 &&
           il[99] == 99 && il.head->data == 0 && il.tail->data == 99 &&
           il.getSize() == 100);
    ...
    nil2.head->data = 1;
    assert(nil2[0] == 1 && nil2[100] == 1 && nil2.head->data == 1 &&
           nil2.tail->data == 1 && nil2.getSize() == 101 && il[0] == 0 &&
           il[99] == 99 && il.head->data == 0 && il.tail->data == 99 &&
           il.getSize() == 100);
  ...
  void testRemove() {
    ...
    assert(il.remove(2) == false && il[0] == 0 && il[1] == 1 &&
           il.head->data == 0 && il.head->next != NULL &&
           il.head->next->data == 1 && il.head->prev == NULL &&
           il.tail->data == 1 && il.tail->next == NULL &&
           il.tail->prev != NULL && il.tail->prev->data == 0 &&
           il.getSize() == 2);
